...
/**
 * struct qbam_async_tx_descriptor - dma descriptor plus a list of xfer_bufs
 *
 * @dma_desc: dma descriptor
...
/**
 * struct bam_device - top level device of current driver
...
/**
 * struct qbam_channel - dma channel plus bam pipe info and current pending transfers
 *
 ...
 * @qbam_chan: dma channel plus bam pipe info and current pending transfers
 */
