...
/*Simple change in accurately feeding frequency to all cores*/ /*SAM*/
//#define NL_RATIO 75
...
#define NL_RATIO 0
#define DEFAULT_HISPEED_LOAD 30
#define DEFAULT_SILVER_RTG_BOOST_FREQ 2000000 // Max freq of 3x2.0 GHz Cortex-A520 cores (2.0 GHz)
#define DEFAULT_GOLD_RTG_BOOST_FREQ 2800000 // Max freq of 4x2.8 GHz Cortex-A720 cores (2.8 GHz)
#define DEFAULT_PRIME_RTG_BOOST_FREQ 3000000 // Max freq of 1x3.0 GHz Cortex-X4 core (3.0 GHz)
#define DEFAULT_TARGET_LOAD_THRESH 256
